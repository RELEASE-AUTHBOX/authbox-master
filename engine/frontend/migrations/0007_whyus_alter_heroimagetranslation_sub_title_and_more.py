...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ...
        ('frontend', '0006_heroimage_heroimagetranslation'),
    ]
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('master', parler.fields.TranslationsForeignKey(editable=False, null=True, on_delete=django.db.models.deletion.CASCADE, related_name='translations', to='frontend.whyus')),
            ],
            options={
