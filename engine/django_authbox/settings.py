...
INSTALLED_APPS=['django.contrib.admin','django.contrib.auth','django.contrib.contenttypes','django.contrib.sessions','django.contrib.messages','django.contrib.staticfiles','django.contrib.sites','django.contrib.humanize',_b,'allauth.account','allauth.socialaccount','allauth.socialaccount.providers.google','allauth.socialaccount.providers.facebook','allauth.socialaccount.providers.github','captcha','multiselectfield','parler','crispy_forms','crispy_bootstrap4','django_ckeditor_5','debug_toolbar','cachalot','mobiledetect','djmoney','menu','region','outbox_hitcount','hitcount','core','backend','frontend']
...
TEMPLATES[0][_I].append(os.path.join(CONTRIBUTE_PATH,_h,_b))
...
CACHES={_D:{_c:'django.core.cache.backends.locmem.LocMemCache','LOCATION':'unique-snowflake'}}
...
CKEDITOR_5_CONFIGS={_D:{_R:[_S,_A,'bold',_i,'link',_T,_U,_V,'imageUpload',_j]},'extends':{'blockToolbar':[_l,_m,_n,_o,_A,_T,_U,_A,_V],_k:{'previewsInData':_J},_R:[_S,_A,'outdent','indent',_A,'alignment',_A,'bold',_i,'underline','strikethrough',_A,'link',_A,_P,'subscript','superscript','highlight',_A,_T,_U,'todoList',_A,'codeBlock','sourceEditing','insertImage',_A,_V,_A,'fontFamily',_j,'fontColor','fontBackgroundColor',_k,'removeFormat','insertTable'],'image':{_R:['imageTextAlternative',_A,'imageStyle:alignLeft','imageStyle:alignRight','imageStyle:alignCenter','imageStyle:side',_A],_p:['full','side','alignLeft','alignRight','alignCenter']},'table':{'contentToolbar':['tableColumn','tableRow','mergeTableCells',_q,_r],_q:{_s:customColorPalette,_t:customColorPalette},_r:{_s:customColorPalette,_t:customColorPalette}},_S:{'options':[{_K:_l,_L:'Paragraph',_M:'ck-heading_paragraph'},{_K:_m,_W:'h1',_L:'Heading 1',_M:'ck-heading_heading1'},{_K:_n,_W:'h2',_L:'Heading 2',_M:'ck-heading_heading2'},{_K:_o,_W:'h3',_L:'Heading 3',_M:'ck-heading_heading3'}]}},'list':{'properties':{_p:_J,'startIndex':_J,'reversed':_J}}}
CRISPY_TEMPLATE_PACK='bootstrap4'
tmp=KEY.get(_u)
MAIN_DOMAIN=KEY[_u]if tmp else'localhost:8000'
