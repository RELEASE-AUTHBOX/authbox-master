...
INSTALLED_APPS=['django.contrib.admin','django.contrib.auth','django.contrib.contenttypes','django.contrib.sessions','django.contrib.messages','django.contrib.staticfiles','django.contrib.sites','django.contrib.humanize',_b,'allauth.account','allauth.socialaccount','allauth.socialaccount.providers.google','allauth.socialaccount.providers.facebook','allauth.socialaccount.providers.github','captcha','multiselectfield','parler','crispy_forms','crispy_bootstrap4','django_ckeditor_5','debug_toolbar','cachalot','mobiledetect','menu','region','outbox_hitcount','hitcount','core','backend','frontend']
