...
MIDDLEWARE+=['debug_toolbar.middleware.DebugToolbarMiddleware','frontend.request_exposer.RequestExposerMiddleware','core.request_exposer.RequestExposerMiddleware']
...
INTERNAL_IPS=['127.0.0.1','localhost',_k]
