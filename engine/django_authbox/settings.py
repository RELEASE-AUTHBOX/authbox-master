...
CKEDITOR_5_CONFIGS={_D:{_R:[_S,_A,'bold',_e,'link',_T,_U,_V,'imageUpload']},'extends':{'blockToolbar':[_g,_h,_i,_j,_A,_T,_U,_A,_V],_f:{'previewsInData':_J},_R:[_S,_A,'outdent','indent',_A,'alignment',_A,'bold',_e,'underline','strikethrough',_A,'link',_A,_P,'subscript','superscript','highlight',_A,_T,_U,'todoList',_A,'codeBlock','sourceEditing','insertImage',_A,_V,_A,'fontFamily','fontSize','fontColor','fontBackgroundColor',_f,'removeFormat','insertTable'],'image':{_R:['imageTextAlternative',_A,'imageStyle:alignLeft','imageStyle:alignRight','imageStyle:alignCenter','imageStyle:side',_A],_k:['full','side','alignLeft','alignRight','alignCenter']},'table':{'contentToolbar':['tableColumn','tableRow','mergeTableCells',_l,_m],_l:{_n:customColorPalette,_o:customColorPalette},_m:{_n:customColorPalette,_o:customColorPalette}},_S:{'options':[{_K:_g,_L:'Paragraph',_M:'ck-heading_paragraph'},{_K:_h,_W:'h1',_L:'Heading 1',_M:'ck-heading_heading1'},{_K:_i,_W:'h2',_L:'Heading 2',_M:'ck-heading_heading2'},{_K:_j,_W:'h3',_L:'Heading 3',_M:'ck-heading_heading3'}]}},'list':{'properties':{_k:_J,'startIndex':_J,'reversed':_J}}}