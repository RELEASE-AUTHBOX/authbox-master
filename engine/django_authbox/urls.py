...
from frontend.views import sitemap_view
handler404='frontend.views.error_404'
handler500='frontend.views.error_500'
urlpatterns=[path(_('secret-admin/'),admin.site.urls),path('',include('core.urls')),path('__debug__/',include('debug_toolbar.urls')),path('docs/',include('docs.urls')),path('accounts/',include('allauth.urls')),path('api/',include('api.urls')),path('ckeditor5/',include('django_ckeditor_5.urls')),path('captcha/',include('captcha.urls')),path('sitemap.xml',sitemap_view,name='sitemap_xml')]
